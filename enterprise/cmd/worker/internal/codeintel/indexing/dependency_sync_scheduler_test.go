...
func TestDependencySyncSchedulerJVM(t *testing.T) {
	...
	mockScanner.NextFunc.PushReturn(lsifstore.PackageReference{Package: lsifstore.Package{DumpID: 42, Scheme: "semanticdb", Name: "name1", Version: "v2.2.0"}}, true, nil)
...
func TestDependencySyncSchedulerGomod(t *testing.T) {
	...
	mockScanner.NextFunc.PushReturn(lsifstore.PackageReference{Package: lsifstore.Package{DumpID: 42, Scheme: "gomod", Name: "name1", Version: "v2.2.0"}}, true, nil)
